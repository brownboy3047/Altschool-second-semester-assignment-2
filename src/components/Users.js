...
export default function Users() {
  ...
  useEffect(() => {
    ...
    // Aborting Fetch Request (i commented it out because i want to keep fetching and not abort after a fetch)
    // return () => {
    //   controller.abort();
    // };
  }, [redirectPage]);
  ...
  return (
    <div className="users">
      ...
      {/* nested Route */}
      <Routes>
        <Route path="offer" element={<p>this is a nice offer</p>} />
      </Routes>
    </div>
  );
}
